...
<span class="cline-any cline-yes">15x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">const plugin = require('tailwindcss/plugin')
...
function configToCss(config) {
  return merge(
    ...
    ...Object.keys(config)
      ...
      .map(<span class="fstat-no" title="function not covered" >(k</span>ey) =&gt; <span class="cstat-no" title="statement not covered" >computed[key](config[key]))</span>,
    ...castArray(config.css || {})
  )
}
&nbsp;
module.exports = plugin.withOptions(
  ({ modifiers = ['sm', 'lg', 'xl', '2xl'], className = 'prose' } = <span class="branch-0 cbranch-no" title="branch not covered" >{})</span> =&gt; {
...
&nbsp;</pre></td></tr></table></pre>
            ...
            <div class='footer quiet pad2 space-top1 center small'>
                ...
                at Fri Oct 23 2020 15:00:07 GMT+0200 (Central European Summer Time)
            </div>
        </div>
